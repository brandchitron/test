...
module.exports.onChat = async ({
 ...
 const randomReplies = ["🦆", "𝙃𝙤𝙥 𝙗𝙚𝙙𝙖🦆, 𝘽𝙤𝙨𝙨 বল 𝙗𝙤𝙨𝙨🦆", "𝙒𝙝𝙖𝙩'𝙨 𝙪𝙥?", "বলো কি বলবা, সবার সামনে বলবা নাকি?🦆💨", "𝙣𝙚𝙬 𝙢𝙮 𝙜𝙧𝙤𝙪𝙥 𝙢𝙚𝙨𝙨𝙚𝙣𝙜𝙚𝙧 𝙙𝙚𝙬 https://www.facebook.com/shuvo.2k3", "আমাকে ডাকলে, আমি কিন্তূ কিস করে দেবো🦆", "𝘽𝘼𝘽𝙐 𝙆𝙃𝙐𝘿𝘼 𝙇𝘼𝙂𝙎𝙀🦆"];
 if (!arr) {
